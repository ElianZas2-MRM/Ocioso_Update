...
from osocio.providers.lambdatest_mac.lt_excel_reader import read_osocio_excel  # type: ignore[import]
    ...
    try:
        ...
        for i, lead in enumerate(leads, start=1):
            ...
            if "✓" in result["result_text"]:
                ...
                # más tarde (mismo criterio que fail_rows en base_form_filler.py / lt_runner.py).
